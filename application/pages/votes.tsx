...
const Votes = () => {
    ...
    return (<>
        <Box sx={{ mt: 3 }}>
            ...
            <Dialog open={isOpen}>
                <Box sx={{ display: 'flex', flexDirection: 'column', padding: 5, borderRadius: 5 }}>
                    ...
                    }} onClick={handleOnSubmitBtn} disabled={!selectedCandidateHash}>Submit</Button>
                </Box>
        ...
        <Backdrop
            sx={{ color: '#fff', zIndex: (theme) => Math.max.apply(Math, Object.values(theme.zIndex)) + 1 }} open={Boolean(isGivingVoteProcessLoading)}>
