...
import { StyledCardTypography, StyledOngoingElectionBox, StyledViewBtn } from '../styles/electionCardStyle'
...
const OngoingElectionCard = ({ electionId, electionName, startTime, endTime }: ElectionCardProps) => {
