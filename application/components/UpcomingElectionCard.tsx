...
const UpcomingElectionCard = ({ electionId, electionName, startTime, endTime }: ElectionCardProps) => {
    ...
    return (
        <StyledUpcomingElectionBox onClick={handleOnClick}>
