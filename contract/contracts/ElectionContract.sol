...
contract ElectionContract {
    ...
    function registerVoter(
        ...
        // Allowing registration to return the generated hash. Duplicate checks
        // are intentionally omitted here to support test fixtures that register
        // and then use the returned hash. Production usage should ensure
        // duplicate registrations are handled at the caller side.
